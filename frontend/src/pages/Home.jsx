        ...
        {visibleCount < filteredCourses.length && (
          <div className="flex justify-center mt-20">
            <button 
              ...
              className="btn btn-warning btn-outline rounded-none px-16 font-black tracking-[0.3em] uppercase hover:bg-yellow-600 hover:text-black transition-all shadow-xl shadow-yellow-600/5"
            >
              Cargar más archivos
            </button>
          </div>
